//
//  PrivateMainPrivateViewController.m
//  CoreDataExample
//
...
#import "PrivateMainPrivateViewController.h"
...
@interface PrivateMainPrivateViewController ()
@property CardGenerator *cg;
@property PrivateMainPrivateController *rcpc;
@end

@implementation PrivateMainPrivateViewController
@synthesize cg;
@synthesize rcpc;
...
- (void)viewDidLoad {
    ...
    rcpc = [[PrivateMainPrivateController alloc] init];
    rcpc.delegate = self;
